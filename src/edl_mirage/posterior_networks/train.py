        ...
        if epoch % frequency == 0:
            ...
            print(
                "Epoch {} -> Val loss {} | Val Acc.: {}".format(
                    epoch, round(val_losses[-1], 3), round(val_accuracies[-1], 3)
                )
            )
            ...
            if int(epoch / frequency) > patience and val_losses[-patience] <= min(
                val_losses[-patience:]
            ):
...
def train_sequential(
    ...
    train_losses_1, val_losses_1, train_accuracies_1, val_accuracies_1 = train(
        model,
        train_loader,
        val_loader,
    ...
    train_losses_2, val_losses_2, train_accuracies_2, val_accuracies_2 = train(
        model,
        train_loader,
        val_loader,
        max_epochs=max_epochs,
